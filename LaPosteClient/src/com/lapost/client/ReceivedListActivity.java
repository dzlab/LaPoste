...
public class ReceivedListActivity extends ListActivity {
    ...
    protected void loadListContent() {
    	...
    	try {
         ...
         adapter = new SimpleAdapter(
                ...
                new String[] {"identifier", "nameSender", "state", "type"},           
                new int[] {R.id.identifier, R.id.name, R.id.state, R.id.type});  
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {  
     	HashMap data=(HashMap)adapter.getItem(position);
    		...
    		wake.putExtra("SENT_LIST_OR_RECEIVED_LIST", "RECEIVED_LIST");
    		startActivity(wake);
    ...
    protected void onResume(){
 	   if(Constants.shouldRefreshReceivedList){
        new ProgressTask(ReceivedListActivity.this).execute();
        Constants.shouldRefreshReceivedList=false;
 	   }
        super.onResume();
     }
