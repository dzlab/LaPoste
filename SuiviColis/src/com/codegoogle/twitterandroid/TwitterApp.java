...
public final class TwitterApp {
	public static final String TAG = TwitterApp.class.getSimpleName();
  //
  ...
  public static final String CALLBACK_URL = "http://laposte-webapp.appspot.com/"; //"twitterapp://connect";
