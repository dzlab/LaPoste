...
public class C2DM_TestServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			conn.setRequestProperty("Authorization", "GoogleLogin auth=" + ServerConfig.AuthToken);
				...
				if (responseCode.equals(401)) {
					...
					if (responseCode.equals(200)) {
						...
						if (updatedAuthToken != null) {
							...
							sb.append("updatedAuthToken = \"" + updatedAuthToken + "\"");
						}
						...
						if (responseLine == null || responseLine.equals("")) {
							sb.append("Got responsecode " + responseCode + " but a empty response from Google AC2DM server");
						} else {
